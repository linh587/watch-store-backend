...
router.put(
  "/information",
  extractFormData,
  UserValidate.updateInformation,
...
router.put(
  "/cart/:productPriceId",
  UserValidate.updateCartDetail,
  UserController.updateCartDetail
);
...
router.patch(
  "/notification/mark-is-seen",
  UserValidate.markNotificationIsSeen,
  UserController.markNotificationIsSeen
);
