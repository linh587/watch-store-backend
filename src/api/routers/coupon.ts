...
router.post(
  "/decrease-money",
  CouponValidate.calculateAmountOfDecreaseMoney,
  CouponController.calculateAmountOfDecreaseMoney
);
router.post(
  "/relation",
  CouponValidate.findRelationCoupons,
  CouponController.findRelationCoupons
);
