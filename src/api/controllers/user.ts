...
export async function updateInformation(
  req: FormDataRequest<UserRequest>,
  res: Response
) {
  const { userAccountId } = req;
...
export async function updatePassword(req: UserRequest, res: Response) {
  ...
  const success = await UserAccountService.updatePassword(
    userAccountId,
    oldPassword,
    newPassword
  );
...
export async function getCartDetail(req: UserRequest, res: Response) {
  ...
  const cartDetail = await CartService.getExtraCartDetail(
    userAccountId,
    productPriceId
  );
  res.json(cartDetail);
...
export async function deleteCartDetail(req: UserRequest, res: Response) {
  ...
  const success = await CartService.deleteCartDetail(
    userAccountId,
    productPriceId
  );
  if (success) {
...
export async function createOrder(req: UserRequest, res: Response) {
  ...
  const information = req.body[
    "order"
  ] as OrderService.InformationToCreateOrder;
  ...
  if (orderId) {
    const productPriceIdsInUserCart = information.details.map(
      ({ productPriceId }) => productPriceId
    );
    await Promise.all(
      productPriceIdsInUserCart.map((productPriceId) =>
        CartService.deleteCartDetail(userAccountId, productPriceId)
      )
    );
...
export async function getOrders(req: UserRequest, res: Response) {
  ...
  const orders = await OrderService.getOrdersByUserAccount(
    userAccountId,
    options,
    filters
  );
...
export async function updateRating(req: UserRequest, res: Response) {
  ...
  const success = await RatingService.updateRating(
    userAccountId,
    productId,
    information
  );
