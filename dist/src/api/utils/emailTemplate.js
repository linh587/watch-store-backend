...
export function getEmailTemplate(order, details, amountOfDecreaseMoney) {
    return `
  <!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    <div
      ...
      <table
                      ...
                      <b
                        style="
                          font-family: -apple-system, BlinkMacSystemFont,
                            ...
                            'Segoe UI Symbol';
                        "
                        >${moment(order?.createdAt).format("DD-MM-YYYY HH:mm:ss")}</b
                      >
                    </p>
                    <p
                      style="
        ...
        : "Thanh toán online qua ví VNPay"}</b
                      >
                    </p>
                    <p
                      style="
...
export function listProductTemplate(item) {
