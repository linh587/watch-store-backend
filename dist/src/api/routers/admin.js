...
router.post("/product-size", AdminValidate.addProductSize, AdminController.addProductSize);
router.put("/product-size/:productSizeId", AdminValidate.updateProductSize, AdminController.updateProductSize);
router.delete("/product-size/:productSizeId", AdminController.deleteProductSize);
...
router.put("/coupon/:couponCode", AdminValidate.updateCoupon, AdminController.updateCoupon);
router.delete("/coupon/:couponCode", AdminController.deleteCoupon);
router.post("/promotion", extractFormData, AdminValidate.addPromotion, AdminController.addPromotion);
router.put("/promotion/:promotionId", extractFormData, AdminValidate.updatePromotion, AdminController.updatePromotion);
router.delete("/promotion/:promotionId", AdminController.deletePromotion);
router.post("/banner", extractFormData, AdminValidate.addBanner, AdminController.addBanner);
router.put("/banner/:bannerId", extractFormData, AdminController.updateBanner, AdminController.updateBanner);
router.delete("/banner/:bannerId", AdminController.deleteBanner);
router.get("/user-account", AdminController.getUserAccounts);
router.patch("/user-account/:userAccountId/lock", AdminController.lockUserAccount);
router.patch("/user-account/:userAccountId/unlock", AdminController.unlockUserAccount);
router.get("/rating", AdminController.getAllRatings);
router.patch("/rating/:userAccountId/:productId/lock", AdminController.lockRating);
router.patch("/rating/:userAccountId/:productId/unlock", AdminController.unlockRating);
